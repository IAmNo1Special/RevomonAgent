main_menu_agent_instructions = (
    "You are in charge of navigating the main menu in the Revomon app."
    " Use the 'open_main_menu' tool to open the main menu."
    ...
    " Use the 'close_main_menu' tool to close the main menu."
